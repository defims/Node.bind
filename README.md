...
render:
    ...
    <div class="elementArray"><!--nodeBindData: {childBinding:[], index: 2, instances: [], scope: ObservableArray}-->
        <div class="arrayChild">2</div>
    </div>
    <div class="elementArray"><!--nodeBindData: {childBinding:[], index: 3, instances: [], scope: ObservableArray}-->
        <div class="arrayChild">3</div>
    </div>
    <div class="elementArray"><!--nodeBindData: {childBinding:[], index: 4, instances: [], scope: ObservableArray}-->
        <div class="arrayChild">4</div>
    </div>
    <div class="elementArray"><!--nodeBindData: {childBinding:[], index: 5, instances: [], scope: ObservableArray}-->
        <div class="arrayChild">5</div>
    </div>
    <div class="elementArray"><!--nodeBindData: {childBinding:[], index: 6, instances: [], scope: ObservableArray}-->
        <div class="arrayChild">6</div>
    </div>
    <div class="elementArray"><!--nodeBindData: {childBinding:[], index: 7, instances: [], scope: ObservableArray}-->
